...
export class OrderModel {
  ...
  async store(order: BaseOrder): Promise<Order> {
    ...
    try {
      ...
      throw new Error(
        `Cant store order something wrong happened ${user_id}. ${err}`
      );
    }
  } // end method store
  ...
  async update(id: number, newOrderData: BaseOrder): Promise<Order> {
    ...
    try {
      ...
      throw new Error(
        `Cant update order something wrong happened ${user_id}. ${err}`
      );
    }
  } // end method update
  ...
  async destroy(id: number): Promise<Order> {
    try {
      ...
      throw new Error(
        `Cant delete order something wrong happened ${id}. ${err}`
      );
    }
  } // end method destroy
